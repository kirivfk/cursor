...
export const metadata: Metadata = {
  title: 'Streaming Silos - Cámara en directo',
  description: 'Emisión 24 horas desde Santo Domingo de Silos (Burgos)'
};

export default function SilosCamPage() {
  return (
    <div className="min-h-screen">
      <section className="bg-gradient-to-br from-sky-50 to-blue-100 dark:from-slate-800 dark:to-slate-900 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mt-4 text-primary dark:text-white">Santo Domingo de Silos</h1>
