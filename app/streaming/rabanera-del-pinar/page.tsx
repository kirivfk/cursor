    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-5xl mx-auto py-8 px-4">
        <div className="aspect-video w-full rounded-xl overflow-hidden border border-gray-100 dark:border-slate-700 bg-black">
          <iframe
            src="https://www.duartec.es/rabanera.php"
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-3">
          ...
          <a href="https://www.duartec.es/rabanera.php" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">ver en duartec.es</a>
        </p>
      </section>
    </div>
  );
