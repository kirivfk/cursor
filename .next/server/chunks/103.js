  ...
  (exports.modules = {
    ...
    9671: (e, t, r) => {
      ...
      function S(e) {
        let {
          ...
          b = (0, a.useContext)(i.LayoutRouterContext);
    ...
    6199: (e, t, r) => {
      ...
      function c(e) {
        ...
        let {
          ...
          b = p ? (0, n.createHrefFromUrl)(p) : y;
        (0, u.addRefreshMarkerToActiveParallelSegments)(c, b);
        let m = new Map();
        (null === f || 0 === f.size) &&
          (0, o.fillLazyItemsTillLeafWithHead)(v, void 0, c, s, g);
        let R = {
          buildId: r,
          tree: c,
          cache: v,
            ...
            (t) => {
              ...
              for (let t of r) {
                let r = t.slice(0, -4),
                  n = t.slice(-3)[0],
                  c = ['', ...r],
                  d = (0, a.applyRouterStatePatchToTree)(c, v, n, S);
                if (
                  (null === d &&
                    (d = (0, a.applyRouterStatePatchToTree)(c, T, n, S)),
                  null !== d)
                ) {
    ...
    5240: (e, t, r) => {
      ...
      let n = r(5424),
        ...
        g = r(5652),
        h = r(4158),
        { createFromFetch: y, encodeReply: _ } = r(6493);
...
${t}`
    ...
    7165: (e, t, r) => {
      ...
      function y(e, t) {
        t.debug(
          '@opentelemetry/api: Unregistering a global for ' + e + ' v' + s + '.'
        );
        var r = c[p];
        r && delete r[e];
      }
            ...
            function e(e) {
              return function () {
                for (var t = [], r = 0; r < arguments.length; r++)
                  t[r] = arguments[r];
                var n = h('diag');
                if (n) return n[e].apply(n, P([], R(t), !1));
              };
            }
            var t = this;
      ...
      var Z = {
        ...
        eu = (function () {
          ...
          return (
            ...
            (e.prototype.disable = function () {
              (this._getContextManager().disable(), y(ei, S.instance()));
            }),
            e
          );
        })();
      ...
      var ec = '0000000000000000',
        es = '00000000000000000000000000000000',
        ed = { traceId: es, spanId: ec, traceFlags: a.NONE },
        ef = (function () {
          function e(e) {
        ...
        ep = N('OpenTelemetry Context Key SPAN');
      function eg(e) {
      ...
      function eS(e) {
        return eR.test(e) && e !== ec;
      }
      function eO(e) {
        return eP(e.traceId) && eS(e.spanId);
      }
      function eE(e) {
        return new ef(e);
      }
      var eT = eu.getInstance(),
        ex = (function () {
          function e() {}
          return (
        ...
        eC = (function () {
          ...
          return (
            ...
            (e.prototype._getTracer = function () {
              ...
              return e ? ((this._delegate = e), this._delegate) : ej;
            }),
            e
          );
        })(),
        ...
        eN = (function () {
          ...
          return (
            ...
            (e.prototype.getDelegate = function () {
              var e;
              return null !== (e = this._delegate) && void 0 !== e ? e : eM;
            }),
                ...
                ((this._internalState = e
                  ...
                  .reduce(function (e, t) {
                    ...
                    if (-1 !== n) {
                      ...
                      ew.test(o) && eI.test(a) && !eD.test(a) && e.set(o, a);
                    }
                    return e;
                  }, new Map())),
      ...
      var eF = eu.getInstance(),
        ...
        e$ = N('OpenTelemetry Baggage Key');
      function eX(e) {
        return e.getValue(e$) || void 0;
      }
      function ez() {
        return eX(eu.getInstance().active());
      }
      function eK(e, t) {
      ...
      var eY = 'propagation',
        ...
        eJ = (function () {
          function e() {
            ((this.createBaggage = C),
              (this.getBaggage = eX),
              (this.getActiveBaggage = ez),
              (this.setBaggage = eK),
              (this.deleteBaggage = eW));
          }
          return (
            (e.getInstance = function () {
              return (
        ...
        eZ = (function () {
          function e() {
            ((this._proxyTracerProvider = new eN()),
              (this.wrapSpanContext = eE),
              (this.isSpanContextValid = eO),
              (this.deleteSpan = e_),
              (this.getSpan = eg),
          ...
          return (
            ...
            (e.prototype.setGlobalTracerProvider = function (e) {
              var t = g(eQ, this._proxyTracerProvider, S.instance());
              return (t && this._proxyTracerProvider.setDelegate(e), t);
            }),
            (e.prototype.getTracerProvider = function () {
              return h(eQ) || this._proxyTracerProvider;
            }),
            (e.prototype.getTracer = function (e, t) {
              return this.getTracerProvider().getTracer(e, t);
            }),
            (e.prototype.disable = function () {
              (y(eQ, S.instance()), (this._proxyTracerProvider = new eN()));
            }),
            e
          );
        })().getInstance();
    ...
    9943: (e, t, r) => {
      ...
      e.exports = n(
        'C:\\Users\\kiri_\\Documents\\cursor\\node_modules\\next\\dist\\client\\components\\app-router.js'
      );
    },
    3144: (e, t, r) => {
      'use strict';
    ...
    1354: (e, t) => {
      ...
      let { env: n, stdout: o } =
        ...
        m = l('\x1b[34m', '\x1b[39m'),
        R = l('\x1b[35m', '\x1b[39m'),
        P = l('\x1b[38;2;173;127;168m', '\x1b[39m'),
        S = l('\x1b[36m', '\x1b[39m'),
        O = l('\x1b[37m', '\x1b[39m'),
        E = l('\x1b[90m', '\x1b[39m'),
        T = l('\x1b[40m', '\x1b[49m'),
          ...
          let u = async (u, s) => {
            ...
            return (0, o.getTracer)().trace(
              ...
              async () => {
                ...
                if (R) return e(u, s);
                let _ = r.getStore();
                if (!_ || _.isDraftMode) return e(u, s);
                let m =
                    u && 'object' == typeof u && 'string' == typeof u.method,
                  P = (e) => (null == s ? void 0 : s[e]) || (m ? u[e] : null),
                  S = (e) => {
                    var t, r, n;
                    return void 0 !==
                      (null == s
                ...
                ('string' == typeof C &&
                  ...
                  ((m && 'default' === C) ||
                    i.warn(
                      `fetch for ${v} on ${_.urlPathname} specified "cache: ${C}" and "revalidate: ${O}", only one should be specified.`
                    ),
                  (C = void 0)),
                  'force-cache' === C
                    ? (O = !1)
                    : ('no-cache' === C ||
                        ...
                        'only-no-store' === x) &&
                      (O = 0),
                  ('no-cache' === C || 'no-store' === C) && (M = `cache: ${C}`),
                  (y = d(O, _.urlPathname)));
                let N = P('headers'),
                  A =
                ...
                switch (x) {
                  ...
                  case 'force-cache':
                    (void 0 === O || 0 === O) &&
                      ((M = 'fetchCache = force-cache'), (y = !1));
                }
                (void 0 === y
                  ? 'default-cache' === x
                    ? ((y = !1), (M = 'fetchCache = default-cache'))
                    : D
                      ? ((y = 0), (M = 'auto no cache'))
                      : 'default-no-store' === x
                        ? ((y = 0), (M = 'fetchCache = default-no-store'))
                        : j
                          ? ((y = 0), (M = 'noStore call'))
                          : ((M = 'auto cache'),
                            (y =
                      ...
                      ('number' != typeof y ||
                        (!1 !== _.revalidate &&
                          ('number' != typeof _.revalidate ||
                            !(y < _.revalidate))))) ||
                    (0 === y && (0, l.trackDynamicFetch)(_, 'revalidate: 0'),
                    (_.revalidate = y)));
                let L = ('number' == typeof y && y > 0) || !1 === y;
                if (_.incrementalCache && L)
                  try {
                    o = await _.incrementalCache.fetchCacheKey(v, m ? u : s);
                  } catch (e) {
                    console.error('Failed to generate cache key for', u);
                  }
                let U = _.nextFetchId ?? 1;
                _.nextFetchId = U + 1;
                let F = 'number' != typeof y ? a.CACHE_ONE_YEAR : y,
                  k = async (t, r) => {
                    let n = [
                      'cache',
                      'credentials',
                    ...
                    if (m) {
                      ...
                      let { _ogBody: e, body: r, signal: n, ...o } = s;
                      s = { ...o, body: e || r, signal: t ? void 0 : n };
                    }
                    let a = {
                      ...s,
                      next: {
                      ...
                      if (
                        (t ||
                          h(_, {
                            ...
                            url: v,
                            cacheReason: r || M,
                            cacheStatus: 0 === y || r ? 'skip' : 'miss',
                            status: e.status,
                            method: a.method || 'GET',
                          }),
                        200 === e.status && _.incrementalCache && o && L)
                      ) {
                ...
                if (o && _.incrementalCache) {
                  G = await _.incrementalCache.lock(o);
                  ...
                  if (
                    (e
                      ? await G()
                      : (p = 'cache-control: no-cache (hard refresh)'),
                    ...
                    if (_.isRevalidate && e.isStale) H = !0;
                      ...
                      if (
                        ...
                        (e.catch(console.error), (_.pendingRevalidates[o] = e));
                      }
                      let t = e.value.data;
                      h(_, {
                        start: b,
                ...
                if (_.isStaticGeneration && s && 'object' == typeof s) {
                  let { cache: e } = s;
                  if (!_.forceStatic && 'no-store' === e) {
                    let e = `no-store fetch ${u}${_.urlPathname ? ` ${_.urlPathname}` : ''}`;
                    ((0, l.trackDynamicFetch)(_, e), (_.revalidate = 0));
                    let r = new t(e);
                    throw (
                      (_.dynamicUsageErr = r),
                ...
                if (!o || !H) return k(!1, p).finally(G);
                {
                  ...
                  let t = k(!0, p).then(c.cloneResponse);
                  return (
                    (e = t
                      .then(async (e) => {
                        let t = e[0];
                      ...
                      .finally(() => {
                        if (o) {
                          var e;
                          (null == (e = _.pendingRevalidates)
                            ? void 0
                            : e[o]) && delete _.pendingRevalidates[o];
                        }
                      })).catch(() => {}),
                    (_.pendingRevalidates[o] = e),
                    t.then((e) => e[1])
                  );
                }
              }
